...
typedef void(^PYDidReturnDataBlock) (id data, PYSearchViewController *vc);
/**
...
/**
 The search bar
 */
@property (nonatomic, weak) MyCustomSearchBar *searchBar;
...
@property (nonatomic, copy) PYDidReturnDataBlock didReturnDataBlock;
/**
